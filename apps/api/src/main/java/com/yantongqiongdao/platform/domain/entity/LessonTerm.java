...
public class LessonTerm {
    ...
    @Column(name = "mandarin_text", nullable = false, length = 100)
    private String mandarinText;

    @Column(name = "hainan_text", nullable = false, length = 100)
    private String hainanText;

    @Column(name = "pinyin_note", length = 100)
    private String pinyinNote;
    ...
    public String getPinyinNote() {
        return pinyinNote;
    }

    public void setPinyinNote(String pinyinNote) {
        this.pinyinNote = pinyinNote;
    }
